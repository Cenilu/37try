document.addEventListener('DOMContentLoaded', function () {
    ...
    btnLocate.addEventListener("click", function () {
        // Temporarily enable pointer events for btnLocate
        btnLocate.style.pointerEvents = "auto";

        // Set a timeout to reset pointer events after 2 seconds (adjust as needed)
        setTimeout(function () {
            btnLocate.style.pointerEvents = "none";
